...
class Template16 {
  ...
  Template16({required Resume16ThemeModel? resume16theme}) {
    ...
    background = resume16theme.background ?? PdfAssets.back54;
  ...
  Future<File?> createPage() async {
    ...
    print(" Template16: All widgets built successfully");
    ...
    try {
      ...
      final file = File("${outputDir.path}/Resume_T16_$timestamp.pdf");
      await file.writeAsBytes(await pdf.save());
      print("Pdf Saved To ${file.path}");
      return file;
    } catch (e) {
      print('Failed to save PDF for Template16: $e');
      return null;
    }
  }
          ...
          children: [
            if (profileImage != null)
              Container(
                ...
                height: 120,
                padding:
                    imageBorder54 != null ? EdgeInsets.all(8) : EdgeInsets.zero,
                ...
                child: Container(
                  decoration: BoxDecoration(
                    border: Border.all(
                        width: 2, color: PdfColor.fromHex("#B87397")),
                    shape: BoxShape.circle,
                  ),
                  child:
        ...
        child: _buildRotatedSection(
          ...
          content: Column(
            ...
            children: [
              ...
              if (linkIc != null)
                _buildContactRow(link_54!, contactData?.personnelWeb),
            ],
          ),
        ),
      ),
