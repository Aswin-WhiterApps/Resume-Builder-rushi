...
class Template1 {
  ...
  Template1(
      {required Resume1ThemeModel? resume1theme,
      required CL1ThemeModel? cl1themeModel}) {
    nameFont = Font.helveticaBold();
    normalFont = Font.helvetica();
    headerFont = Font.helveticaBold();
    nameColor = resume1theme?.nameColor ?? PdfColors.black;
    headerColor = resume1theme?.headerColor ?? PdfColors.black;
    normalColor = resume1theme?.normalColor ?? PdfColors.grey800;
    bulletPathFromTheme = resume1theme?.bullet;
  }
    ...
    try {
      ...
      if (bulletPathFromTheme != null && bulletPathFromTheme!.isNotEmpty) {
        imageFutures.add(rootBundle.load(bulletPathFromTheme!).then((byteData) {
          t3_bullet = MemoryImage(byteData.buffer.asUint8List());
        }));
      }
        ...
        children: [
          if (t3_bullet != null)
            Padding(
                ...
                child: Image(t3_bullet!, width: 4, height: 4))
          else
