...
class Template11 {
  ...
  Future<File?> createPage() async {
    ...
    print(" Template11: All widgets built successfully");
    ...
    try {
      ...
      final file = File("${outputDir.path}/Resume_T11_$timestamp.pdf");
          ...
          children: [
            if (profileImage != null)
              Container(
                ...
                height: 120,
                padding:
                    imageBorder2 != null ? EdgeInsets.all(8) : EdgeInsets.zero,
        ...
        child: _buildRotatedSection(
          ...
          content: Column(
            ...
            children: [
              ...
              if (link_42 != null)
                _buildContactRow(link_42!, contactData?.personnelWeb),
            ],
          ),
        ),
      ),
