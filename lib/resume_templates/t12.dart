    ...
    try {
     ...
     if (imageBorder != null && imageBorder!.isNotEmpty) {
      ...
      if (linkIc != null && linkIc!.isNotEmpty) {
        // previously this incorrectly assigned the link image into phone_43.
        // Store the loaded link image into link_43 instead.
        imageFutures.add(rootBundle
            .load(linkIc!)
            ...
            Padding(
              ...
              child: _buildRotatedSection(
                ...
                content: Column(
                  ...
                  children: [
                    if (emailIc != null && email_43 != null)
                      _buildContactRow(email_43!, contactData?.email),
                    if (phoneIc != null && phone_43 != null)
                      _buildContactRow(phone_43!, contactData?.phone),
                    if (linkIc != null && link_43 != null)
                      _buildContactRow(link_43!, contactData?.socialMediaUrl1),
                    if (linkIc != null && link_43 != null)
                      _buildContactRow(link_43!, contactData?.socialMediaUrl2),
