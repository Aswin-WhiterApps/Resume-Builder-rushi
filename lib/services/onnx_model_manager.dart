...
class ONNXModelManager {
  ...
  Future<void> _loadModels() async {
    try {
      ...
      final phi3ModelPath = await _getModelPath('Phi-3-mini-4k-instruct.onnx');
      final embeddingModelPath = await _getModelPath('all-MiniLM-L6-v2.onnx');
      ...
      if (await embeddingFile.exists() && await embeddingFile.length() > 0) {
        ...
        print('⚠️ Embedding model file not found, using simple similarity calculation');
      }
