        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
                colorFilter: ColorFilter.mode( ColorManager.promo1BgColor, BlendMode.multiply),
                image: AssetImage(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Image.asset(ImageAssets.promo1Logo,height: 200,width: 200,),
                              ...
                              Stack(children: [
                                Text(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontSize: FontSize.s27,letterSpacing: 3,
                                      foreground: Paint()..style = PaintingStyle.stroke..strokeWidth = 5..color = Colors.white
                                  ),
                                ),
                                Text(
                                  "Upagrade Now !",
                ...
                ElevatedButton(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(color: ColorManager.white,strokeAlign: BorderSide.strokeAlignInside,width: 3)
                    ),
                    child: Container(
                      padding: EdgeInsets.symmetric(vertical:AppPadding.p8,horizontal: 30),
                      decoration: BoxDecoration(
                          color: Colors.white,
                          borderRadius: BorderRadius.circular(30),
                          border: Border.all(color: ColorManager.promo2buttonColor,strokeAlign: BorderSide.strokeAlignInside,width: 3)
                      ),
                      child: Text(
                        "Go Add-Free",
                        textScaleFactor: 1.5,
