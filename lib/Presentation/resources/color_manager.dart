...
class ColorManager {
  ...
  static Color secondary = HexColor.fromHex("#4294FE");
  static Color darkGrey = HexColor.fromHex("#393D3f");
  static Color grey = HexColor.fromHex("#737477");
  static Color lightGrey = HexColor.fromHex("#9E9E9E");
  static Color primaryOpacity70 = HexColor.fromHex("#4294FE");
  ...
  static Color splashBackColor = HexColor.fromHex("#E0F7FA");
  ...
  static Color faintWhite = HexColor.fromHex("#F9F9F9");
...
extension HexColor on Color {
  static Color fromHex(String hexColorString) {
    ...
    if (hexColorString.length == 6) {
      hexColorString = "FF" +
          hexColorString; //Appending characters for opacity of 100% at start of HexCode
    }
